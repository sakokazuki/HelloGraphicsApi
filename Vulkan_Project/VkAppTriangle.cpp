...
void VulkanAppTriangle::prepare()
{
...
void VulkanAppTriangle::cleanup()
{
...
VulkanAppTriangle::BufferObject VulkanAppTriangle::createBuffer(uint32_t size, VkBufferUsageFlags usage)
{
	BufferObject obj;
...
VkPipelineShaderStageCreateInfo VulkanAppTriangle::loadShaderModule(const char* fileName, VkShaderStageFlagBits stage)
{
