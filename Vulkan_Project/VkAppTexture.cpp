...
void VulkanAppTexture::makeCubeGeometry()
{
	const float k = 1.0f;
...
void VulkanAppTexture::prepareUniformBuffers()
{
...
void VulkanAppTexture::prepareDescriptorSetLayout()
{
...
void VulkanAppTexture::prepareDescriptorPool()
{
...
void VulkanAppTexture::prepareDescriptorSet()
{
...
VulkanAppTexture::BufferObject VulkanAppTexture::createBuffer(uint32_t size, VkBufferUsageFlags usage, VkMemoryPropertyFlags flags)
{
	BufferObject obj;
...
VkPipelineShaderStageCreateInfo VulkanAppTexture::loadShaderModule(const char* fileName, VkShaderStageFlagBits stage)
{
...
VkSampler VulkanAppTexture::createSampler()
{
	VkSampler sampler;
...
VulkanAppTexture::TextureObject VulkanAppTexture::createTexture(const char* fileName)
{
...
void VulkanAppTexture::setImageMemoryBarrier(
	VkCommandBuffer command,
	VkImage image,
